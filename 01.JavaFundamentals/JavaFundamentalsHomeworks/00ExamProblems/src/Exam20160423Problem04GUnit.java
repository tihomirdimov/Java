...
public class Exam20160423Problem04GUnit {
        ...
        LinkedHashMap<String, LinkedHashMap<String, ArrayList<String>>> sortedClasses =
                classesDatabase
                        ...
                        .sorted((firstClass, secondClass) -> {
                            ...
                            Integer result = Integer.valueOf(Exam20160423Problem04GUnit.getAllUnitTests(secondClass.getValue().values())
                                    .size())
                                    .compareTo(Integer.valueOf(Exam20160423Problem04GUnit.getAllUnitTests(firstClass.getValue().values())
                                            .size()));
