...
public class Exam20151004Problem02DragonAccounting {
    public static void main(String[] args) {
        ...
        while(!(inputLine = scanner.nextLine().split("\\;"))[0].equals("END")){
            ...
            BigDecimal[] employeeObj = new BigDecimal[]{new BigDecimal(1)
                    ,dayCounter,hiredEmployeesSalary,new BigDecimal(hiredEmployees)};
